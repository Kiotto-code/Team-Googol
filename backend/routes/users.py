...
def get_users_stats():
    ...
    try:
        ...
        # Convert to dicts and remove passwords from top lists
        top_finders_clean = []
        for user in top_finders:
            user_dict = dict(user)
            user_dict.pop('password', None)
            top_finders_clean.append(user_dict)
            
        top_claimers_clean = []
        for user in top_claimers:
            user_dict = dict(user)
            user_dict.pop('password', None)
            top_claimers_clean.append(user_dict)
        ...
        return jsonify({
            ...
            'data': {
                ...
                'top_finders': top_finders_clean,
                'top_claimers': top_claimers_clean
            }
        })
